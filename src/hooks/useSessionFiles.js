...
const fileAPI = {
  ...
  getSessionFiles: async (sessionId) => {
    const response = await axios.get(`${API_URL}/sessions/${sessionId}/files`);
  ...
  uploadFile: async ({ sessionId, file, userEmail }) => {
    ...
    const response = await axios.post(
      `${API_URL}/sessions/${sessionId}/files/upload`,
      formData,
      {
        headers: {
  ...
  deleteFile: async ({ sessionId, fileId, userEmail }) => {
    const response = await axios.delete(
      `${API_URL}/sessions/${sessionId}/files/${fileId}`,
      {
        data: { userEmail }
      }
    );
  ...
  downloadFile: async ({ sessionId, fileId }) => {
    const response = await axios.get(
      `${API_URL}/sessions/${sessionId}/files/${fileId}/download`,
      {
        responseType: 'blob'
      }
    );
